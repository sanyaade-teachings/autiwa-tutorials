...
\subsection{Récupérer le contenu en lecture seule (pour de la production)}
Pour créer un dossier \textbf{modules} dans le dossier courant contenant l'architecture du dépot SVN, il suffit de faire :
\begin{verbatim}
svn checkout http://autiwa-py-modules.googlecode.com/svn/trunk/ modules
\end{verbatim}

Ici, pas besoin de mot de passe, c'est juste pour accéder aux mises à jours. 
