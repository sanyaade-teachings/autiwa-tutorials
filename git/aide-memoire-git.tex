...
\begin{remarque}
La fois où j'ai utilisé bisect, je me suis retrouvé sur une branche \textbf{(no branch)} sans m'en rendre compte, et j'ai donc fait des modifications là, sans réaliser que je ne modifiais plus \textbf{master}. Pour plus d'infos, voir \refsec{sec:no-branch}.
\end{remarque}
