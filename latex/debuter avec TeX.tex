...
\begin{remarque}
Il faut faire attention à ne pas trop modifier les choses. En particulier le caractère d'échappement pour pouvoir faire du \LaTeX. Ça peut donner des erreurs de compilation suivant les caractères qu'on met dans l'environnement \texttt{lstlisting}.
\end{remarque}
