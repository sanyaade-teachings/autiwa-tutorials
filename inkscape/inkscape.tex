...
\section{Astuces pour les motifs}
...
\section{Astuces pour les textes}
...
\section{Effets de chemin}
Ces trois subsectiones d'explications ont étés pris sur le site \\
\url{http://www.pixenjoy.com/inkscape-046-live-path-effects}
\subsection{Courber un chemin}
...
\subsection{Motif suivant un chemin}
...
\subsection{Relier les sous-chemins}
