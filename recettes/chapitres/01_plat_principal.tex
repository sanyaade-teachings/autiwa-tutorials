...
\begin{recette}{Velouté de courgette}{3}{45 min}{}
\begin{ingredients}
\ingredient 1.5kg de courgettes
\ingredient bouillon de volaille
\ingredient 250g de boursin 'ou équivalent ail et fines herbes)
\ingredient basilic, sel, poivre
\end{ingredients}

\begin{preparation}
\etape Coupez les courgettes en morceaux 
\etape Dans la marmite, ajoutez de l'eau jusqu'à couvrir les courgettes et faites bouillir pendant 30 minutes dans le bouillon
de volaille. 
\etape Égouttez alors mixez les courgettes ainsi cuites avec le fromage
\etape Ajoutez le basilic, sel, poivre.
\etape Rajoutez du bouillon pour avoir l'onctuosité voulue
\end{preparation}
\end{recette}
