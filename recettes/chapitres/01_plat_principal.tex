...
\begin{recette}{Brandade de Lotte}{2}{45min}{}
\begin{ingredients}
...
\etape Mettez l'huile à chauffer dans une cocotte et faites-y revenir le canard 10 min environ, de tous les côtés, puis égouttez-le et jetez la graisse de cuisson.
\etape Faites revenir les champignons
...
\etape Versez le sucre dans une casserole. Ajoutez une cuillerée à soupe d'eau et faites caraméliser, puis retirez du feu et arrosez avec le vinaigre.
\etape Posez la cocotte sur feu vif, versez-y le sirop des pêches, les pêches si elles sont dures et le caramel vinaigré. Faites bouillir en grattant le fond du récipient pour dissoudre les sucs de viande et rectifiez l'assaisonnement au besoin.
\etape Retirez du feu, ajoutez le Cognac et mélangez. Si les pêches sont bien mûres, ajoutez-les maintenant, et laissez simplement réchauffer.
...
\ingredient 3 cuillerées à soupe rase de moutarde à l'ancienne
...
\ingredient 100--200g de petits pois
...
\begin{recette}{Ratatouille confite}{3}{1h30}{10h}
\begin{ingredients}
\ingredient 200g de lardons
...
\begin{preparation}
\etape Peler et épépiner les tomates, puis les mixer avec les 5 gousses d'ail. Mettre le jus obtenu dans une casserole avec le sucre et le laurier et les herbes. Faire réduire jusqu'à la consistance d'une purée. (les autres légumes rendront de l'eau, ce n'est pas grave si la purée est bien réduite).
\etape Pendant ce temps, préparez les légumes : 
\etape Faire revenir les lardons, puis mettez les avec la pulpe de tomate.
\etape Émincer les oignons épluchés et les faire fondre à feu doux dans une poêle avec du poivre. Verser dans une cocotte en fonte et faire mijoter à feu très doux.
\etape Émincer les poivrons et les faire fondre avec du sel jusqu'à ce qu'ils soient mous. Les mettre dans la cocotte.
\etape Laver les courgettes, les couper en petits cubes et les faire dorer à la poêle. Les mettre dans la cocotte et continuer la cuisson à feu très doux.
\etape Laver les aubergines, les couper en petits cubes et les faire dorer avec du poivre. Quand elles sont molles les ajouter dans la cocotte.
\etape Ajouter le concentré de tomates et la purée de tomates. 
\end{preparation}

\begin{cuisson}
Laisser mijoter à découvert pendant 7 à 10h environ à feu très doux. 
