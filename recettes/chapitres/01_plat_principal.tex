...
\begin{recette}{Porc au caramel}{0}{1h30}{40min}
%Cette recette sans soja ni rien n'est pas très bonne, il faut vraiment ces deux sauces pour le goût
...
\ingredient 2 oignons
\ingredient 2 gousses d'ail
\ingredient 1 cuillère à café de gingembre
...
\begin{preparation}
\etape couper le porc en fins morceaux (je fais des tranches, puis des lamelles, et je coupe ces lamettes en morceaux de quelques centimètres).
\etape Hachez l'ail et l'oignon (au mixeur)
\etape Faire mariner le porc avec tous les ingrédients de la sauce sauf l'eau.
\etape Faites saisir les morceaux de porc égouttés
\etape Ajoutez alors la marinade et l'eau dans la sauteuse puis diminuez le feu et couvrez
\etape Dans une casserole, versez le sucre à sec. Une fois la couleur caramel obtenue, versez les sauces (nuoc man et sauja, 2 cuillères à soupe chacune) et remuez rapidement en faisant attention aux projections éventuelles.
\etape Versez alors le caramel obtenu dans la sauteuse puis homogénéisez la sauce.
\end{preparation}

\begin{cuisson}
Couvrez et laissez mijoter 40 minutes environ
\end{cuisson}
...
\begin{recette}{Tajine d'agneau aux pruneaux}{0}{1h}{2h}
\begin{ingredients}
...
\ingredient $\sfrac{1}{2}$ cuillère à café de cannelle
\ingredient $\sfrac{1}{2}$ cuillère à café de gingembre
...
\etape Lorsque les morceux sont bien dorés, mettez-les dans une cocotte avec les oignons. Salez et poivrez. Ajoutez l'ail écrasé, la cannelle, le gingembre, la safran et les grains de coriandre.
\etape Rajoutez le bouillon dans lequel ont trempé les pruneaux et faites cuire à couvert une heure à feux doux
\etape Ajoutez ensuite les pruneaux égouttés, puis poursuivez la cuisson 20 min à couvert.
\begin{remarque}
