...
\begin{preparation}
\etape Séparez pilon et cuisse des cuisses de canard. Émincez l'oignon et les champignons dans des récipients séparés. Hachez 
finement l'ail à l'aide d'une fourchette
\etape Dans une marmite, faites mijoter à feu moyen et à couvert le vin blanc et l'ail, avec un peu de céleri et du poivre. 
...
\etape Réservez les oignons dans un 2e récipient puis faites revenir les lardons afin d'utiliser la graisse pour la suite
\etape Réservez les lardons avec les oignons, puis faites revenir les champignons. 
\etape Ajoutez de nouveau les oignons et lardons, mélangez, puis saupoudrez de farine. Homogénéisez la préparation. 
\etape 
\end{preparation}

\begin{cuisson}
Ajoutez enfin le tout dans la marmite de vin blanc, mélangez pour obtenir la sauce. Ajoutez les morceaux de canard, couvrez. 
Faites alors cuire 45 minutes environ à feu doux et à couvert.
\end{cuisson}
\end{recette}
