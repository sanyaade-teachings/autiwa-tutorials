\begin{recette}{Blanquette de Veau}{3}{20 min}{2h}
\begin{ingredients}
...
\begin{recette}{Brandade de poisson}{2}{1h30}{}
\begin{ingredients}
...
\begin{recette}{Calamars à l'armoricaine}{2}{}{}
\begin{ingredients}
...
\begin{recette}{Canard aux pêches en cocotte}{4}{30 min}{1h30}
...
\begin{recette}{Choucroute}{3}{30 min}{2h}
...
\begin{recette}{Daube}{4}{15 min.+12h+45min.}{6h}
\begin{ingredients}
...
\begin{recette}{Gigot d'agneau fondant en cocotte}{3}{30 min}{5 heures}
\begin{ingredients}
...
\begin{recette}{Magret de canard aux poires}{4}{}{}
\begin{ingredients}
...
\begin{recette}{Paëlla (à la moi)}{3}{45 min}{30 min}
\begin{ingredients}
...
\etape Faites le revenir dans un peu d'huile
\etape A pendant 10 minutes environ puis sortez du feu en
...
\begin{recette}{Porc au caramel}{0}{30min + 1h + 30min}{40min}

\begin{ingredients}
\ingredient[Pour la sauce]
\ingredient un roti dans l'échine (800g environ)
\ingredient 2 oignons
\ingredient 2 gousses d'ail
\ingredient Un petit morceau de gingembre frais
\ingredient 2 cuillères à café de Nuoc man (ou sauce de poisson)
\ingredient 4 cuillères à soupe de sauce sauja (de préférence la foncé)
\ingredient 25 cl d'eau

\ingredient[Pour le caramel]
\ingredient 50g de sucre (environ 4 cuillères à soupe)
\ingredient 2 cuillères à café de Nuoc man
\ingredient 2 cuillères à soupe de sauce sauja
\end{ingredients}

\begin{preparation}
\etape couper le porc en fins morceaux (je fais des tranches, puis des lamelles, et je coupe ces lamelles en morceaux de
quelques centimètres).
\etape pelez puis mixez l'ail, le gingembre et l'oignon
\etape Faire mariner le porc avec tous les ingrédients de la sauce sauf l'eau pendant 1h environ.
\etape Égouttez le porc dans une passoire, en mettant un saladier en dessous. 
\etape Faites saisir les morceaux de porc égouttés, sans rajouter de matière grasse
\etape Versez l'eau dans la passoire pour récupérer le maximum de ce qui pourrait rester collé sur les cotés. 
\etape Saupoudrez sur le porc une cuillère à soupe de farine, puis mélangez. 
\etape Ajoutez alors la marinade et l'eau dans la sauteuse puis diminuez le feu et couvrez
\begin{remarque}
N'ajoutez pas plus de sauce soja ou nuoc man, ça rajoute beaucoup de sel. par contre, afin de couvrir la viande, vous pouvez
rajouter de l'eau.
\end{remarque}

\etape Dans une casserole, versez le sucre à sec. Une fois la couleur caramel obtenue, versez lentement les sauces (nuoc man
et sauja que vous avez préparé dans un verre) et remuez en même temps afin de ne pas solidifier le caramel.
\etape Versez alors le caramel obtenu dans la sauteuse puis homogénéisez la sauce.
\end{preparation}
...
\begin{recette}{Poulet aux pruneaux et à la crème de whisky}{3}{1h30}{}
\begin{ingredients}
...
\begin{recette}{Ratatouille confite}{4}{1h30}{10h}
\begin{ingredients}
\ingredient 200g de lardons
...
\begin{recette}{Tajine d'agneau aux pruneaux}{0}{1h}{4h}
\begin{ingredients}
\ingredient 500g de pruneaux
\ingredient 500g d’oignon (à peu près)
...
\ingredient une cuillère à café de gingembre
...
\etape Lorsque les morceaux sont bien dorés, mettez-les dans une cocotte avec les oignons. Salez et poivrez. Ajoutez l'ail
écrasé, la cannelle, le gingembre, la safran et les grains de coriandre.
...
\begin{cuisson}
Faites cuire à feux doux et à couvert pendant 3 ou 4h. Ajoutez les pruneaux égouttés 30 minutes avant la fin de la
cuisson.
\end{cuisson}
