\begin{recette}{Blanquette de Veau}
\statistique{0}{}{}
\begin{ingredients}
...
\begin{recette}{Brandade de morue}
\statistique{0}{}{}
\begin{ingredients}
...
\begin{recette}{Calamars à l'armoricaine}
\statistique{3}{}{}
\begin{ingredients}
\ingredient 1 boite moyenne de tomates en dés
\ingredient 1 boite de coulis de tomate (ou une 2e boite de tomates en dés)
...
\begin{recette}{Canard à la Bourguignonne}
\statistique{5}{}{}
% (Excellent)
...
\begin{recette}{Canard aux pruneaux}
...
\begin{recette}{Cassoulet (7 pers.)}
\statistique{0}{}{}
\begin{ingredients}
...
\begin{recette}{Couscous (pour 8 personnes)}
\statistique{4}{}{}
\begin{ingredients}
...
\begin{recette}{Crépinettes de canard aux raisins}
\statistique{0}{}{}
\begin{ingredients}
...
\begin{recette}{Crépinettes en sauce}
\statistique{3}{}{}
...
\begin{recette}{Filet mignon de porc aux champignons}
\statistique{4}{}{}
\begin{ingredients}
...
\begin{recette}{Filet mignon de porc au bleu}
\statistique{2}{}{}
\begin{ingredients}
\ingredient 2 filets mignons de porc
...
\begin{recette}{Gigot d'agneau rôti au lard}
\statistique{3}{}{}
\begin{ingredients}
...
\begin{recette}{Grattin Dauphinois}
\statistique{3}{}{}
\begin{ingredients}
...
\begin{recette}{Lapin à la moutarde (6 pers.)}
\statistique{5}{}{}
\begin{ingredients}
...
\begin{recette}{Lapin à la tomate (4 pers.)}
\statistique{5}{}{}
\begin{ingredients}
\ingredient un lapin
...
\begin{recette}{Lapin en gibelote}\index{Paupiette de veau}\index{lapin}\index{gibelote}
\statistique{4}{}{}
\begin{ingredients}
\ingredient un lapin
...
\begin{recette}{Magret de canard aux myrtilles}
\statistique{4}{}{}
\begin{ingredients}
...
\begin{recette}{Paëlla (garniture déjà prête)}
\statistique{0}{}{}
\begin{ingredients}
...
\begin{recette}{Pâtes à la bolognaise (à la moi)}
\statistique{4}{}{}
\begin{ingredients}
...
\begin{recette}{Pâtes à la carbonara}
\statistique{4}{}{}
\begin{ingredients}
...
\begin{recette}{Pâtes au boudin}
\statistique{2}{}{}
\begin{ingredients}
\ingredient Boudin à l'oignon, quantité à adapter suivant le nombre de personnes.
\end{ingredients}
...
\begin{recette}{Pâtes au saumon (à la moi)}
\statistique{2}{}{}
\begin{ingredients}
...
\begin{recette}{Pizza à la crème}
\statistique{3}{}{}
\begin{ingredients}
...
\begin{recette}{Pizza aux boulettes de bœuf}
\statistique{3}{}{}
...
\begin{recette}{Porc à la créole}%\index{porc}\index{créole}
\statistique{3}{}{}
\begin{ingredients}
...
\begin{recette}{Roti de Veau en cocotte aux champignons}
\statistique{0}{}{}
\begin{ingredients}
...
\begin{recette}{Tagliatelles aux Noix de St Jacques}
\statistique{1}{}{}
\begin{ingredients}
