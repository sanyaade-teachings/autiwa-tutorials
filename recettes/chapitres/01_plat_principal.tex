...
\begin{ingredients}
\ingredient le jus de 4 ou 5 oranges
...
\ingredient 10 cl d’eau tiède ($\sim\unit{40\degres C}$)
...
\etape Dans une marmite haute, faites revenir l'oignon, l'ail et le poireau dans de l'huile d'olive
\etape Laissez légèrement dorer le tout
\etape Ajoutez ensuite les poissons et un peu d'huile et maintenez à feux doux jusqu'à ce que les poissons colorent
...
\etape Ajoutez le safran et portez à ébullition.
\end{preparation}
