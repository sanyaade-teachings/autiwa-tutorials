...
\begin{recette}{Ratatouille}{0}{1h30}{7h}
\begin{ingredients}
\ingredient 200g de lardons
\ingredient 4 oignons
\ingredient 1kg de tomates
\ingredient 2 aubergines
...
\begin{preparation}
\etape Émincez les légumes assez fins, mettez les gousses d'ail en bouillie. Gardez tous les légumes séparément, puis réservez-les dans le même récipient une fois revenus.
\etape Faites revenir les lardons et réservez les
\etape Faites revenir les oignons à feu vif et réservez les (ajoutez de l'huile d'olive au besoin)
\etape Faites revenir les poivrons à feu vif et réservez les (ajoutez de l'huile d'olive au besoin)
\etape Faites revenir les courgettes à feu vif et réservez les (ajoutez de l'huile d'olive au besoin)
\etape Faites revenir les aubergines à feu vif et réservez les (ajoutez de l'huile d'olive au besoin)
\etape Une fois tous les légumes revenus, remettez tout dans la marmite, ajoutez les tomates coupés en dés fins, l'ail, des herbes de provences, un peu de sel.
\end{preparation}

\begin{cuisson}
Laissez alors mijoter à couvert et à feu très doux 7h heures environ.
\end{cuisson}
\end{recette}
