...
\ingredient 4 bananes
\ingredient Copeaux de chocolat à dessert
\ingredient 1 pâte feuilletée
\ingredient cannelle
\end{ingredients}

\begin{preparation}
\etape Répartir le sucre au fond du moule à tarte
\etape Disposez les bananes préalablement coupées en rondelles d'un centimètre environ
\etape Étalez les copeaux de chocolat sur les bananes
