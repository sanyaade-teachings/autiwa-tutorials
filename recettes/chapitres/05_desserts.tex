...
\ingredient $150$ g de beurre
\ingredient $150$ g de sucre
\ingredient $50$ g de farine
\ingredient $4$ œufs
\ingredient Une tablette de chocolat noir à dessert ($200$ g)
\end{ingredients}

\begin{preparation}
\etape Faire préchauffer le four à $180\degres C$
\etape Faire fondre le beurre au micro-onde environ $1$ à 1 minute $30$ secondes (ou à la casserole)
\etape Y incorporer le sucre et obtenir un mélange homogène.
\etape Faire fondre le chocolat dans une casserole à feu doux en y ajoutant de l'eau (environ $\sfrac{1}{4}$ de verre et en ajouter si le chocolat est trop épais quand il commence à fondre)
\etape Casser un œufs puis ajouter un peu de farine, et ainsi de suite jusqu'à incorporation de tous les œufs et de toute la farine.
\etape Incorporer dans la préparation, le chocolat fondu et verser le contenu dans un moule.
\end{preparation}
