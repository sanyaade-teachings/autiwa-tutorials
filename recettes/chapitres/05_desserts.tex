...
\begin{recette}{Tourteau À l'anis}{2}{2h}{1h}
\begin{ingredients}
...
\ingredient 1 cuillère à soupe de graines d’anis (ou 3 cuillères à soupe d'alcool à base d'anis)
\ingredient 1 pincée de sel
\end{ingredients}
...
\etape Quand la préparation eu centre est trop solide pour qu'on puisse y rajouter encore de la farine, continuez en ajoutant alors le beurre fondu. 
...
\etape Formez à l'aide de la pâte un cylindre, puis formez une couronne. Laissez alors monter la préparation pendant une heure et demi.
\end{preparation}

\begin{cuisson}
Faites cuire la pâte montée pendant 1 heure à 200°C
\end{cuisson}
\begin{remarque}
