...
\ingredient Gros sel de guérande (1kg pour 3 magrets)
\end{ingredients}
...
\etape Poivrez le magret, enveloppez-le dans un torchon propre et placez le au réfrigérateur pendant une semaine environ.
...
\etape Mélangez le sucre, le seul et le thé. Répartir le mélange sur la face du saumon de manière homogène. 
...
\begin{recette}{Roulés au Roquefort}{3}{20 min. + 3h}{20 min.}\index{bleu}\index{roquefort}\index{roulés au roquefort}
...
\ingredient Une cuillère à café de moutarde
\end{ingredients}

\begin{preparation}
\etape Mélangez les ingrédients dans une casserole jusqu'à obtention d'une préparation homogène et pas trop liquide.
\etape Laissez refroidir puis étalez la préparation sur la pâte feuilletée.
\etape Roulez la pâte assez serrée pour obtenir un rouleau de 5cm de diamètre.
\etape Placez le rouleau au congélateur au moins deux heures (je l'ai laissée une nuit). Il faut que ce soit bien congelé, afin que ça ne s'écrase pas quand vous coupez.
\etape Une fois sorti du congélateur, coupez des rondelles d'un peu moins d'1cm d'épaisseur. Placez-les sur une plaque en les espaçant un peu (si les tranches sont fines, ça ne gonfle pas énormément).
\end{preparation}
...
\item Vérifier la cuisson en faisant couler quelques gouttes de confiture sur une assiette froide, le sirop doit être assez 
épais (j'insiste sur le \og épais\fg) et s'écouler lentement.
...
Une fois cuit. Laissez reposer une à deux heures. Préparez pendant ce temps le chocolat à dessert que vous déposerez en cube 
dans un saladier. Une fois reposé, commencez à faire fondre le chocolat au bain marie. L'eau de départ sera chaude (celle du 
robinet), puis allumez le feu au minimum, et remuez le chocolat de temps en temps (le saladier n'est pas obligé d'être 
directement en contact avec l'eau). 

\begin{remarque}
Tout ceci a pour but de ne pas faire brûler le chocolat qui deviendrait alors inutilisable. Le chocolat doit être brillant et 
liquide et onctueux une fois fondu. Il ne faut surtout pas ajouter d'eau dans le chocolat.
\end{remarque}

Laissez le saladier dans le bain marie, et plongez les meringues une par une dans le chocolat afin de les enrober, puis déposez 
les dans un plat afin de laisser le chocolat durcir.
...
\begin{recette}{Tranches d'oranges confite}{4}{}{}\index{orange confites}\index{oranges}\index{fruits confits}
\begin{ingredients}
