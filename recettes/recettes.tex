...
\newcommand{\nomRecette}[1]{{\begin{center}\Huge \bfseries #1\end{center}}\addcontentsline{toc}{section}{#1} }

\newcommand{\ingredient}[1][]{\ifthenelse{\equal{#1}{}}{\item }{\item[\textbf{#1}]}}

\newcommand{\etape}[1][]{\ifthenelse{\equal{#1}{}}{\item }{\item[\textbf{#1}]}}

\newenvironment{recette}[1]{\newpage \nomRecette{#1}}{}

\newcommand{\statistique}[3]{\vspace{.3cm}
...
%TODO modifier l'environnement ingredient pour pouvoir spécifier pour combien de personnes c'est prévu.
%TODO séparer la mise en page des environnements dans des commandes séparées (notamment pour qu''ingredients' et 'ingredients*' n'aient pas de lignes bêtement recopiées
...
\ingredient 1 cuillère à soupe de vinaigre de vin de Xeres
\ingredient 1 cuillère à soupe de vinaigre balsamique
\ingredient 1 cuillère à café rase de sel
\ingredient 1 demi-cuillère à café rase de poivre
\ingredient Éventuellement des herbes
\end{ingredients}

\begin{preparation}
\etape Mettre sel et poivre dans un bol. 
\etape Ajouter le vinaigre pour dissoudre le sel. 
\etape Incorporer ensuite l'huile
\end{preparation}
...
\begin{preparation}
\etape Mélanger la moutarde avec sel et poivre. Ajouter le vinaigre et dissoudre la moutarde. Incorporer l'huile ensuite
\end{preparation}
...
\statistique{0}{}{}
\begin{ingredients}
\ingredient $1$ kg de châtaignes

\ingredient $600$ g de sucre

\ingredient $20$ cl d'eau
\end{ingredients}

\begin{preparation}
\etape Faire une incision sur le dessus de chaque fruit.

\etape Mettre les châtaignes dans une casserole d'eau froide.

\etape Faire boullir les fruits pendant 7/8 minutes.

\etape Les égoutter et retirer l'écorce des fruits.

\etape A la fin de cette opération, remettre les châtaignes a cuire dans un volume d'eau tiède pendant 5 minutes environ (vérifier la cuisson).

\etape Les égoutter et les passer au moulin à légume (grille fine) ou les réduire en purée au robot.

\etape Faire cuire pendant 3 minutes (montre en main) le sucre et l'eau.

\etape Ajouter cette préparation sur la purée de châtaignes et remuer.
\end{preparation}
...
\ingredient $250$ g de chocolat
\ingredient $75$ g de beurre
\ingredient 2 cuillères à soupe de lait
\end{ingredients}

\begin{preparation}
\etape Faire fondre a feu très doux ou au bain-marie, le chocolat en petit morceaux et le lait.
\etape Remuer à l'aide d'une spatule pour obtenir une creme lisse; retirer du feu.
\etape Ajouter les jaunes d'œufs, mélanger, puis le beurre en petit morceaux.
\etape Bien travailler cette préparation (on peut la parfumer avec une pointe de café ou de l'écorce d'orange).
\etape Laisser refroidir dans le réfrigérateur.
\etape Former les truffes et les rouler dans du cacao en poudre, puis les disposer dans des godets\dots
\end{preparation}
