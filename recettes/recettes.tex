...
\newcommand{\preparationTopSep}{\vspace{.2cm} \hrule height0.25pt width\hsize \vspace{.3cm}}
\newcommand{\statistiqueTopSep}{\vspace{.3cm} \hrule height1pt width\hsize \nobreak \vskip\parskip \vspace{.3cm}}
\newcommand{\ingredientsTopSep}{\vspace{.4cm} \hrule height0.75pt width\hsize\vspace*{1\p@}\hrule height0.25pt width\hsize \vspace{.3cm}}
...
% macro qui est utilisée par l'environnement recette, ne doit pas être utilisé directement
...
\newenvironment{preparation}{\preparationTopSep{\partStyle Préparation }\begin{enumerate}}{\end{enumerate}}

% À utiliser si on souhaite faire une mise en page un peu plus évoluée, avec deux listes par exemples.
\newenvironment{preparation*}{\preparationTopSep{\partStyle Préparation }\par}{}
