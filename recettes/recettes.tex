...
\begin{recette}{Roulés au Roquefort}{0}{20 min. + 1h}{20 min.}
\begin{ingredients}[20 petits roulés]
\ingredient Une pâte feuilleté
\ingredient 100g de Roquefort (pas forcément besoin de tout utiliser)
\ingredient 25cl de crème fraîche épaisse (pas sûr)
\ingredient moutarde
\ingredient poivre
\end{ingredients}

\begin{preparation}
\etape Mélangez les ingrédients à l'aide d'une spatule en silicone jusqu'à obtenir une préparation parfaitement lisse. Il faut principalement du roquefort, un peu de moutarde pour relever, un peu de poivre, et pas forcément de crème fraiche, mais il faut que ce soit onctueux et étalable.
...
\etape Placez le rouleau au frigo puis coupez-y des rondelles d'un peu moins d'1 cm d'épaisseur. Placez-les sur une plaque en les espaçant bien.
\end{preparation}
