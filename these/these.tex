\documentclass[logos,chaptertoc]{bordeaux-thesis} % for the numerical version
%\documentclass[logos,chaptertoc,print]{bordeaux-thesis} % For the printed edition (mainly without colors on hyperlinks
