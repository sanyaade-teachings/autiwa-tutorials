...
Une autre formule pour l'amortissement, issue de \citep[eq. (16)]{pierens2013making} : 
\begin{align}
...
\begin{figure}[htbp]
\centering
\subfloat[Densité de surface]{\includegraphics[width=0.49\textwidth]{figure/unitary_tests/density_interpolation.pdf}}\hfill
\subfloat[Indice du profil]{\includegraphics[width=0.49\textwidth]{figure/unitary_tests/density_idx_interpolation.pdf}}
...
\begin{figure}[htbp]
\centering
\subfloat[Température]{\includegraphics[width=0.49\textwidth]{figure/unitary_tests/temperature_interpolation.pdf}}\hfill
\subfloat[Indice du profil]{\includegraphics[width=0.49\textwidth]{figure/unitary_tests/temperature_idx_interpolation.pdf}}
...
thermique]{\includegraphics[width=0.49\textwidth]{figure/unitary_tests/diffusivity_interpolation.pdf}}\hfill
\subfloat[Échelle de hauteur]{\includegraphics[width=0.49\textwidth]{figure/unitary_tests/scaleheight_interpolation.pdf}}

\subfloat[Viscosité]{\includegraphics[width=0.49\textwidth]{figure/unitary_tests/viscosity_interpolation.pdf}}
