...
Chaque mode $k$ possède un nombre de modes $m_k$ déterminée selon une distribution logarithmique entre $m=1$ et $m=150$, le nombre de modes déterminant l'extension radiale et la durée du vie du mode $k$.
