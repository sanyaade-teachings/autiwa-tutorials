...
\subsubsection{Rechercher un bug en utilisant bisect}\index{git!bisect}
...
Il arrive souvent qu'un code scientifique ne plante pas, mais renvoie des informations aberrantes. Git permet de faciliter le processus de débuggage. 
...
%TODO donner l'astuce un peu barbare de récupérer la version du code directement dans le binaire.
...
Je souhaite afficher des informations liées au dépot Git directement dans la console. J'ajoute alors : 
\begin{footnotesize}
\begin{verbatim}
