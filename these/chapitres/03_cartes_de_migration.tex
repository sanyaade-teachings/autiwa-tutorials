%TODO add a meta-map with 9, 12 or 16 disk to show the variety of migration map we can have. An idea of Sean. I leave this here because I don't know exactly what sort of disk I must take. 
...
de la densité locale du disque. 
...
À partir de $5\unit{UA}$, l'irradiation domine le bilanc énergétique \reffig{fig:viscous_vs_irradiation} et une simple comparaison des temps de diffusion ne permet plus d'expliquer simplement l'allure de la carte de migration. Ce n'est plus seulement les temps de diffusions qui permettent de trouver la zone de couple nul dans le disque, mais les valeurs des couples eux mêmes. Au delà de $4\unit{UA}$, sans tenir compte de la saturation les couples augmentent différemment. En effet, au delà de $4\unit{UA}$, le profil de température est dominé par l'irradiation et l'indice du gradient de température diminue avec la distance à partir de $1$ à $4\unit{UA}$ jusqu'à $0.5$ à $40\unit{UA}$. Les couples de Lindblad et de corotation n'ayant pas les mêmes dépendances vis à vis du gradient de température, l'écart entre les couples change.
...
\caption{Profils de température pour différents modèles où l'ombre du disque sur lui-même est calculée différemment.  Les profils des modèles \textbf{direct} et \textbf{étendu} sont confondus. \refdisk}\label{fig:shadow_temp_profile}
\end{figure}
...
\caption{Effet des modèles pour l'ombre du disque sur la carte de migration dans un cas où la densité de surface vaut $\Sigma(R) = 1700 * R^{-1.5}\unit{g/cm^2}$. \refdisk}\label{fig:shadow-example}
\end{figure}
...
\caption{Profil de température et ombre du disque dans le cas du modèle direct ou étendu pour la modélisation de l'ombre. La densité de surface vaut $\Sigma(R) = 1700 * R^{-1.5}\unit{g/cm^2}$. \refdisk}\label{fig:example_shadow_temp_profile}
\end{figure}
...
\caption{Influence du rayon $R_\star$ de l'étoile centrale sur la carte de migration tandis que la luminosité de l'étoile est conservée en variant la température. \refdisk}
\end{figure}\label{fig:map_TTauri_radius}

Le rayon supérieur des TTauri par rapport à des étoiles évoluées, $R=2.5R_\odot$ n'est pas rare \reffig{fig:TTauri_sample}, tendent à atténuer les régions ombrées (\og self-shadowing\fg) du disque. Au cours de son évolution, une étoile TTauri se contracte. À mesure que son rayon diminue, des ombres pourraient donc apparaître dans le disque, modifiant brutalement la carte de migration qui évoluait via la dissipation du disque.
...
Le couple de migration est sensible à la valeur de la viscosité $\nu$ \reffig{fig:constant_viscosity}. La viscosité agit sur la saturation du couple de corotation. Quand la viscosité augmente, le temps de diffusion visqueux $t_\text{visc}$ diminue. Le couple de corotation ne sature pas tant que $(T_\text{visc} < t_\text{lib}/2)$. Si on augmente la viscosité $\nu$, le couple de corotation sature moins facilement à mesure que la masse de la planète augmente. La partie supérieure de la carte de migration se décale vers le haut quand la viscosité augmente. 
...
\caption{Effet conjoint d'une zone morte et du \og self-shadowing\fg. La zone morte s'étend de $1$ à $10\unit{UA}$. Plus de détails sur la modélisation de la zone morte \protect\refsec{sec:dead_zone}. \refdisk}\label{fig:dz_shadow}
\end{figure}
...
Cette zone de convergence ne sera sans doute pas très intéressante au niveau de l'accrétion de masse et de la formation des planètes car peu étendue, mais elle pourrait malgré tout jouer un rôle majeur en maintenant des planètes telluriques de faibles masses (de l'ordre de $1\mearth$) dans le disque, sans besoin d'aucun compagnon massif en résonance pour la maintenir.

La modélisation poussée de l'ombre du disque et son effet sur l'irradiation pourrait donc jouer un rôle majeur au niveau des zones mortes où une zone locale où l'irradiation domine apparaît dû à la décroissance soudaine de la viscosité et du chauffage qui en découle.
...
\begin{figure}[htbp]
\centering
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_01.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_02.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_03.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_04.pdf}}

\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_05.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_06.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_07.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_08.pdf}}

\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_09.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_10.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_11.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_12.pdf}}

\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_13.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_14.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_15.pdf}}\hfill
\subfloat[]{\includegraphics[width=0.24\textwidth]{figure/migration_map/parameter_space/total_torque_16.pdf}}\hfill
