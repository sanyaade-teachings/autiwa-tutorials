...
\dif J(R) &= \dif M(R) \cdot R^2\Omega(R)\label{eq:dJ_in}\\
\dif J(R+\Delta R) &= \vect{r} \wedge \left(\dif M(R+\Delta R) \vect{v}(R+\Delta R)\right)\nonumber\\
\dif J(R+\Delta R) &= \dif M(R+\Delta R) \cdot \left(R+\Delta R\right)^2\Omega(R+\Delta R)\label{eq:dJ_out}
...
\begin{align}
\dod{J_a}{t} &= \dif J(R+\Delta R) - \dif J(R) + \Gamma_\text{in} + \Gamma_\text{out}\label{eq:cons_J_a}
\end{align}

En utilisant \refeq{eq:J_a}, \refeq{eq:dJ}, \refeq{eq:J_torque}, dans \refeq{eq:cons_J_a}
\begin{align*}
\dpd{}{t}\left(2\pi R^3 \Delta R \Sigma(R)\Omega(R)\right) &= \dif M(R+\Delta R) \cdot \left(R+\Delta R\right)^2\Omega(R+\Delta R) - 
\end{align*}
