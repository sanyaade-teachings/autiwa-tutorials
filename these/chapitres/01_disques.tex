...
\subsubsection{Structure verticale du disque}\index{disque!equilibre hydrostatique@équilibre hydrostatique}
...
\end{align}
\end{important}\index{diffusion visqueuse}
...
la densité, mais aussi de l'opacité du disque aux photons stellaires, qui elle-même varie suivant la composition du disque.
...
\subsubsection{Chauffage visqueux}\index{chauffage visqueux}\index{viscosité}
...
\subsubsection{Les disques alpha}\label{sec:viscosite-alpha}\index{prescription alpha}\index{viscosité!alpha}
...
À partir de l'équation \refeq{eq:diffusion_equation}, on peut considérer le cas particulier des disques à l'équilibre, c'est à dire que $\od{\Sigma}{t}=0$. Ces disques sont alors des disques avec un taux d'accrétion $\dot{M}$ constant au cours du temps. 

Ces disques à l'équilibre ont deux solutions possibles\index{disque!equilibre@équilibre}. Soit on a :
\begin{align*}
...
Les deux modèles possibles pour la viscosité, viscosité constante $\nu=\cte$ ou viscosité alpha $\alpha=\cte$ donnent donc 4 solutions différentes (deux chacune) pour les disques à l'équilibre. \index{viscosité!alpha}\index{viscosité!constante}
