...
Lors de la création d'ondes de densité par une planète dans un disque, il se forme un déséquilibre naturel entre les couples agissant sur les parties internes et externes du disque par rapport à la position de la planète. La position des résonances de Lindblad externes tend à être plus proche de la planète que ne l'est celle des résonances internes. Le couple de Lindblad est donc souvent négatif, à condition que la densité de surface diminue avec la distance, ce qui est le cas dans un disque de gaz isolé, non modifié par les intéractions avec des planètes massives, et en négligeant les effets aux bords.

\subsubsection{Couple co-orbital ou de corotation}\index{co-orbital!couple|see{couple}}\index{couple!co-orbital}
Comme son nom l'indique, c'est un couple exercé depuis les zones coorbitales entourant la planète sur cette dernière. Ces orbites ont la particularité de ressembler à un fer à cheval dans le référentiel tournant avec la planète. Les particules fluides sur de telles orbites vont donc passer devant et derrière la planète, à des distances plus ou moins proches suivant l'orbite exacte du fer à cheval. \reffig*{fig:corotation_orbits} illustres différentes orbites possible, une orbite a été colorée en rouge pour bien distinguer une orbite particulière, même si ce n'est pas la seule co-orbite qui existe, bien entendu.
