...
On a tout d'abord les pertes par rayonnement de corps noir. Ces dernières doivent être multiplié par deux, en effet, il y a des pertes par rayonnements des deux cotés du disque à une position donnée : 
\begin{align}
P_\text{cn} &= - 2\sigma T^4
\end{align}
où $\sigma$ est la constante de Stephan.
