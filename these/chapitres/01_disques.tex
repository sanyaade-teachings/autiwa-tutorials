...
Le profil de densité de surface, que ce soit au travers de $\Sigma_0$ ou de l'indice $\alpha$ de la loi de puissance a une
...
Pendant que le gap dû à la planète est en train de se creuser, un mode de migration intermédiaire, appelé migration de 
...
I}, la vitesse de migration est proportionnelle à la masse. Quand la planète devient suffisamment massive pour creuser une 
cavité et migrer par migration de \gras[migration!Type II]{Type II}, la vitesse de migration est gouvernée par la dérive 
