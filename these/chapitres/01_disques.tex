...
\subsubsection{Ionisation et dead-zones}\label{sec:ionisation_DZ}\index{ionisation}\index{dead zone}
...
angulaire s'y fasse peu ou pas du tout \citep{gammie1996layered}. Ces zones, appelées \gras{dead zone}, sont donc des zones où
