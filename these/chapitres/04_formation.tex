...
\section{Zones de convergence et Résonances}\index{résonance!de Moyen Mouvement}
...
\subfloat[$N\simeq 60$]{\includegraphics[width=0.49\textwidth]{%
figure/number_effect/N_60.pdf}}\hfill
\subfloat[Histogramme des masses]{\label{fig:mass_effect}                                              \includegraphics[width=0.49\textwidth]{figure/number_effect/number_effect_on_max_mass.pdf}}
...
\subsection{Le cas de deux planètes}\index{résonance!de Moyen Mouvement}
...
\subsection{Effet des résonances}\index{résonance!de Moyen Mouvement}
