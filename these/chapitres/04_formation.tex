...
Initialement dans le système, on génère des embryons dont la masse varie de $0.1$ à $2\mearth$, pour une masse totale allant de $30$ à $100\mearth$. Des masses aléatoires différentes d'un embryon à l'autre permettent d'éviter les biais dûs aux masses égales. En effet, deux embryons de même masse migrent à la même vitesse, ce qui n'est généralement pas le cas autrement. 
...
En dessous d'une certaine masse limite qui dépend des paramètres du disque mais qui se situe généralement entre $2$ et $10\mearth$, les planètes migrent toutes vers l'intérieur, quelle que soit leur position initiale dans le disque. 

Le premier cas de figure est le suivant : les embryons migrent vers l'intérieur et il n'y a pas suffisamment de collisions durant leur migration pour qu'ils puissent migrer vers l'extérieur à un quelconque moment. On se trouve alors dans le cas d'une formation au bord interne décrite \refsec{sec:inner_edge_formation}. 
...
En raison de la diminution rapide de la densité de surface près du bord interne, la planète ressent un fort couple positif issu à la fois du couple de Lindblad et du couple de corotation. 

Un système de planètes en résonance se forme alors, les planètes internes étant maintenues 
%TODO finir ça

Les planètes entrant dans la cavité interne ne perçoivent plus aucun effet du disque, que ce soit la migration ou l'amortissement de l'excentricité et de l'inclinaison.



Le bord interne est ici l'élément clé du modèle. 

Le bord interne stoppe la migration pour plusieurs raisons. La première raison est que la densité de surface est lissée de sorte que la densité juste avant la fin du disque soit proche de 0. Une décroissance rapide de la densité de surface
%TODO finir
%TODO regarder les couples de lindblad et de corotation au bord interne pour voir d'où provient la migration vers l'extérieur qui maintien les planètes dans le système
