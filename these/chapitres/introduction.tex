...
\begin{figure}[htb]
\centering
\includegraphics[width=0.45\linewidth]{figure/milky_way_exoplanets.jpg}%TODO non .pdf parce qu'il y a des soucis avec l'export .pdf de .svg contenant des .jpg
