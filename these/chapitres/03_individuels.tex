...
%TODO 
\subsection{Diagrammes de couple a-m}\label{sec:migrations-maps}\label{sec:reference_disk}
...
%TODO présenter que si on augmente la force de migration ou le nombre d'embryons on augmente la compression (visible avec un diagramme des resonnances)