...
L'existence et la forme des zones de convergence est essentiellement dû à la variation du couple de corotation en fonction de divers paramètres. Ce sont les variations du couple de corotation qui engendrent un couple total positif ou négatif, selon qu'il est capable de contrebalancer ou non le couple différentiel de Lindblad. 

Il existe essentiellement deux types de zone de convergence différents, dont les caractéristiques proviennent des raisons physiques à l'origine des variations du couple de corotation. 

\bigskip

Les zones de convergence indépendantes de la masse sont crées par transition d'opacité. La chute brutale de l'opacité engendre un fort gradient d'entropie. On passe alors d'un couple fortement positif à l'intérieur du rayon de la transition d'opacité, à un couple fortement négatif ensuite. Toutes les planètes, quelle que soit leur masse, migrent à la même position dans le disque, dans une certaine région donnée. 

Les migrations modélisées \refsec{sec:linear_indep} et \refsec{sec:tanh_indep} permettent de modéliser de telles zones de convergences de manière artificielles, nous permettant de s'affranchir des cartes de migrations complexes d'un disque modélisée de manière cohérente.

\begin{figure}[htb]
\centering
\subfloat[$t_\text{rad}/t_\text{U-turn}$]{\includegraphics[width=0.49\textwidth]{figure/timescales/linear_rad.pdf}}\hfill
\subfloat[$t_\text{visc}/t_\text{U-turn}$]{\includegraphics[width=0.49\textwidth]{%
figure/timescales/linear_visc.pdf}}

\subfloat[$t_\text{lib}/(2*t_\text{rad})$]{\includegraphics[width=0.49\textwidth]{figure/timescales/sat_rad.pdf}}\hfill
\subfloat[$t_\text{lib}/(2*t_\text{visc})$]{\includegraphics[width=0.49\textwidth]{%
figure/timescales/sat_visc.pdf}}


\caption{Comparaison des différents temps caractéristiques influençant le couple de corotation, notamment vis à vis de la saturation. Ces inéquations sont détaillées dans \refsec{sec:couple-corotation}.}\label{fig:timescales_maps}
\end{figure}

\begin{figure}[htb]
\centering
\subfloat[Linear Barotropic torque]{\includegraphics[width=0.49\textwidth]{figure/details/baro_lin_torque.pdf}}\hfill
\subfloat[Horseshoe barotopic torque]{\includegraphics[width=0.49\textwidth]{%
figure/details/baro_hs_torque.pdf}}

\subfloat[Linear Entropy related torque]{\includegraphics[width=0.49\textwidth]{figure/details/ent_lin_torque.pdf}}\hfill
\subfloat[Horseshoe Entropy related torque]{\includegraphics[width=0.49\textwidth]{%
figure/details/ent_hs_torque.pdf}}


\caption{Evolution des deux parties du couple de corotation, la partie barotropique ou liée au gradient d'entropie, dans les deux cas, le cas linéaire, ou le cas non-saturé.}\label{fig:details_maps}
\end{figure}
