...
%TODO parler des subroutines et fonctions. Expliquer la différence (ou les) entre les deux en dessous de la section ``procédures'' (c'est à dire pas dans une des deux sous sections.
