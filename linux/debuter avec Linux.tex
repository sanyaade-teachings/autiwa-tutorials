...
\subsubsection{Extraire la première frame d'une vidéo (ou .gif)}
Il suffit d'utiliser \gras[imagemagick]{ImageMagick} : 
\begin{verbatim}
convert 'dynamical_instabilities.mov[0]' dynamical_instabilities_00.png
\end{verbatim}
...
\verb|[^...]| & recherche un caractère parmi le complément aux caractères dans les crochets. \verb|[^a-z]| recherche tout caractère qui n'est pas une lettre minuscule. \\ \hline
