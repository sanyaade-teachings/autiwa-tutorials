...
\includegraphics[width=0.15\textwidth]{pdf/logo-ubuntu.pdf}\hfill\includegraphics[width=0.15\textwidth]{pdf/logo-GNU.pdf}\hfill\includegraphics[width=0.15\textwidth]{pdf/logo-debian.pdf}\\[1cm]
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.4\textwidth]{pdf/matlab_damier.pdf}
